...
class Transport {
  ...
  constructor(categoryName, config) {
    ...
    //
    const rsyslogTransport = new (winston.transports.Rsyslog)(config);
    //
    const rsyslogTransport_log = rsyslogTransport.log;
    rsyslogTransport.log = function(appLevel, msg, meta, callback) {
      ...
      rsyslogTransport_log.call(this, sylogLevel, msg, meta, callback);
    };

    return rsyslogTransport;
